...
public class OrderedMenuDto extends MenuDto implements Serializable {
	...
	public OrderedMenuDto(Date order_date, String id, String menu_type, String menu_name, int count, int coupon,
			int price) {
	...
	@Override
	public String toString() {
		return super.toString() + "OrderedMenuDto [order_date=" + order_date + ", id=" + id + ", menu_type=" + menu_type
				+ ", coupon=" + coupon + ", count=" + count + ", price=" + price + "]";
	}
